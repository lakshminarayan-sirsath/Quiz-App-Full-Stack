...
let totalQuestions = 0; // Set total questions dynamically

// Fetch questions from the backend
async function fetchQuestions() {
    try {
        const response = await fetch('http://localhost:8080/api/questions?quizType=java-script');
        if (!response.ok) {
...
async function saveScore() {
    ...
    const quizType = 'javascript'; // Specify the quiz type
